"""Module pour la gestion des tâches liées à l'archivage et au rapport de mission."""
...
# 2. Copions journal_bord.txt dans mission_data/archives/ en le renommant avec
#  la date du jour : journal_bord_2026-02-18.txt (utilisez le module datetime).
os.system(f'mv {journal_bord_path} {archives_dir}/journal_bord_{datetime.date.today()}.txt')
...
with open(rapport_path, 'w', encoding='utf-8') as f:
    ...
    # La liste des variables d’environnement liées à Python (os.environ) —
    #  filtrez celles contenant "PYTHON" ou "PATH".
...
print("- Construction des chemins de fichiers avec \
    'os.path.join()' pour une meilleure portabilite.")
print(f"- Deplacement de 'journal_bord.txt' vers \
    '{archives_dir}' avec un nom incluant la date actuelle.")
print(f"- Creation du rapport systeme dans '{rapport_path}' avec les informations \
    sur le repertoire courant, les variables d'environnement et l'espace disque.")
